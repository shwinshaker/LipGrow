...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample_x=None, downsample_v=None, stepsize=1):
        ...
        self.downs_x = downsample_x
        self.downs_v = downsample_v
        self.stride = stride
...
class AccNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        downsample_x, downsample_v = None, None
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample_x, downsample_v))
    ...
    def forward(self, x0):
        ...
        x, v = self.layer1((x, v))  # 32x32, 16
        x, v = self.layer2((x, v))  # 16x16, 32
        x, v = self.layer3((x, v))  # 8x8, 64
